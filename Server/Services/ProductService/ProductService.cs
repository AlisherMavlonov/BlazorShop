using Product = RazorShop.Shared.Product;
...
public class ProductService : IProductService
{
    ...
    public async Task<ServiceResponse<ProductSearechResult>> SearchProduct(string searchText, int page)
    {
        var pageResults = 2f;
        ...
        var response = new ServiceResponse<ProductSearechResult>()
        {
            Data = new ProductSearechResult()
            {
                Products = products,
                CurrentPage = page,
                Pages = (int)pageCount
    ...
    public async Task<ServiceResponse<List<Product>>> GetFeaturedProducts()
    {
        var response = new ServiceResponse<List<Product>>()
        {
            Data = await _context.Products
                ...
                .Include(f => f.Variants.Where(v=>v.Visible && !v.Deleted))
                .ToListAsync()
        };
